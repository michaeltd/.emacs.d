...
* Files
  ...
  3. [[file:themes][themes]]
     ...
     1) [[file:themes/gotham-theme.el][gotham]]
     2) [[file:themes/jazz-theme.el][jazz]]
     3) [[file:themes/ujelly-theme.el][ujelly]]
     4) [[file:themes/xresources-theme.el][xresources]]
* Load Sequence
** Init
*** some variables
