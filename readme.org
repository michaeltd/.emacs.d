...
* Files
  ...
  3. [[file:themes][themes]]
     ...
     1) [[themes/cyberpunk-theme.el][cyberpunk]]
...
*** [[themes][themes]]
    ...
    ;; doom-themes
    (when (tdm/laptop-p)
        (add-to-list 'load-path (concat user-emacs-directory "lisp/emacs-doom-themes"))
        (require 'doom-themes)
        (load-theme 'doom-outrun-electric t))
    (when (not (tdm/laptop-p))
        (load-theme 'cyberpunk t))
    #+END_SRC
...
* Contributing
  Buy me some coffee in [[https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3THXBFPG9H3YY&source=michaeltd/.emacs.d][\euro]] or ₿ (bitcoin:3KCPkfTWqanYfgNvoUKP1S4bFXTDpaReUs) so I can up my game.
