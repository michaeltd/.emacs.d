...
- Load Times
  ...
  (buy me a coffee [[https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3THXBFPG9H3YY&source=michaeltd.netlify.com][eur \20AC]], no seriously, even in [[bitcoin:3KCPkfTWqanYfgNvoUKP1S4bFXTDpaReUs?amount=0.1][btc \20BF]])

  # <!-- <p align="center">buy me coffee... &#x20AC; &#x20BF; --> 

  #+BEGIN_SRC shell
  time emacs --eval '(kill-emacs)' # This should yield < 1^s
  #+END_SRC
